...
import MarketCommonStatistics from '@/components/marketCommonStatistics/MarketCommonStatistics.vue';
import MarketOrderStatistics from '@/components/marketOrdersStatistics/MarketOrderStatistics.vue';
