...
import { UiSwitch } from '@terminal/uikit/components/switch/index';
import TakeProfitList from '@/components/takeProfitList/TakeProfitList.vue';
...
import OrderFormEstimates from '@/components/orderForm/composables/orderFormEstimates/OrderFormEstimates.vue';
import { useMarketStore } from '@/stores/market';
import { injectOrderFormState } from '@/components/orderForm';
