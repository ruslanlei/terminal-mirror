...
} from '@/components/orderList/collectTableRecord';
import CloseOrderButton from '@/components/closeOrderButton/CloseOrderButton.vue';
import OrderListPlaceholder from '@/components/orderList/OrderListPlaceholder.vue';
import SubOrderList from '@/components/orderList/subOrderList/SubOrderList.vue';
import {
