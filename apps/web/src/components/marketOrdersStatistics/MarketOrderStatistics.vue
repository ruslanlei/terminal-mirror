...
import StatisticsSuccessOrders from '@/components/statisticsSuccessOrders/StatisticsSuccessOrders.vue';
import StatisticsFailedOrders
  from '@/components/statisticsFailedOrders/StatisticsFailedOrders.vue';
import StatisticsTurnover from '@/components/statisticsTurnover/StatisticsTurnover.vue';
