...
import EcosystemCard from '@/components/ecosystemCap/ecosystemCard/EcosystemCard.vue';
import { IEcosystemCard } from '@/components/ecosystemCap/ecosystemCard';
import SpaceBackground from '@/components/ecosystemCap/spaceBackground/SpaceBackground.vue';
