...
const ChangePlayerDateModal = defineAsyncComponent(() => import('@/components/changePlayerDateModal/ChangePlayerDateModal.vue'));
const DeleteOrderModal = defineAsyncComponent(() => import('@/components/deleteOrderModal/DeleteOrderModal.vue'));
const SuccessSignUpModal = defineAsyncComponent(() => import('@/components/successSignUpModal/SuccessSignUpModal.vue'));
const ConfirmModal = defineAsyncComponent(() => import('@/components/confirmModal/ConfirmModal.vue'));
